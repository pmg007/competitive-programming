...
class HrankNikitaAndTheGame {
	public static long a[]=new long[100010];
	public static long sum(int l, int r){
		return a[r]-a[l-1];
	}
	public static int binary(int l, int  r, long s){
	...
	public static int solve(int l,int r){
		long s=sum(l,r);
		if(l!=r &&s%2==0){
			int i=binary(l,r,s/2);
			if(i!=-1){
				return Math.max(solve(l,i),solve(i+1,r))+1;				
			}
		}
		return 0;
	}
